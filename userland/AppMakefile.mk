...
LIBS_$(1) += $$(TOCK_USERLAND_BASE_DIR)/libtock/build/$(1)/libtock.a
...
$$(BUILDDIR)/$(1)/$(1).elf: $$(OBJS_$(1)) $$(LIBS_$(1)) $$(LAYOUT) | $$(BUILDDIR)/$(1) $$(TOCK_USERLAND_BASE_DIR)/newlib/$(1)/lto_archive_workaround
	$$(TRACE_LD)
	$$(Q)$$(CC) $$(CFLAGS) -mcpu=$(1) $$(CPPFLAGS)\
	    ...
	    -nostdlib\
	    $$(LD_FORCE_FNS)\
	    -Wl,--start-group $$(OBJS_$(1)) $$(LIBS_$(1)) $$(LIBS) $$(TOCK_USERLAND_BASE_DIR)/newlib/$(1)/lto_archive_workaround/*.o -Wl,--end-group\
